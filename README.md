...
Download the versioned release asset from the [v1.0.0 release](https://github.com/rmach816/change-order-recovery-audit/releases/tag/v1.0.0), then install the `.mcpb` in Claude Desktop on Windows.
